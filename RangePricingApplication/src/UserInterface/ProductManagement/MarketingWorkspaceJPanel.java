...
=======
    ...
    private void btnApplyChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApplyChangesActionPerformed
        ...
        if (product != null) {
            ...
            System.out.println("✅ Recorded price change: " + selectedProductName + 
                             " (" + oldPrice + " → " + newTargetPrice + ")");
...
private class ProductPerformanceData {
    ...
    private void btnAutoOptimizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAutoOptimizeActionPerformed
        ...
        "Products selling ABOVE target → Price increases by 10%\n" +
        "Products selling BELOW target → Price decreases by 10%\n\n" +
...
private void updateFilterStatus(String supplierName) {
    ...
    if ("All Suppliers".equals(supplierName)) {
        System.out.println("📊 Showing all " + rowCount + " products");
    } else {
        System.out.println("📊 Showing " + rowCount + " products from " + supplierName);
    }
}
...
private void refreshProductsTable() {
    ...
    for (TheBusiness.Supplier.Supplier supplier : suppliers) {
        ...
        for (TheBusiness.ProductManagement.Product product : catalog.getProductList()) {
            ...
            Object[] row = {
                supplier.getName(),      // 🆕 ADDED: Supplier Name (Column 0)
    ...
    System.out.println("✅ Loaded " + productCount + " products into table with color coding and supplier names");
}
...
>>>>>>> 84bfef0d41fb9d4ad1067e54de2782b4afabb4fe
